...
func (c *checkpointServiceClient) CreateCheckpoint(ctx context.Context, in *CheckpointRequest, opts ...grpc.CallOption) (*CheckpointResponse, error) {
...
func (UnimplementedCheckpointServiceServer) CreateCheckpoint(context.Context, *CheckpointRequest) (*CheckpointResponse, error) {
...
func _CheckpointService_CreateCheckpoint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckpointServiceServer).CreateCheckpoint(ctx, req.(*CheckpointRequest))
	}
...
var CheckpointService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/checkpoint/v1/checkpoint.proto",
}
